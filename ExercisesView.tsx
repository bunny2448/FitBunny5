...
import { Trash2, Video as VideoIcon, ChevronDown, ChevronUp } from 'lucide-react';
...
export const ExercisesView: React.FC<ExercisesViewProps> = ({ exercises, onDelete, totalCount }) => {
  ...
  if (totalCount === 0) {
    return (
      <div className="py-20 text-center bg-white border border-[#EEEEEE] rounded-[2rem]">
        <p className="text-[#AAAAAA] font-bold">No exercises found.</p>
      </div>
    );
  }
